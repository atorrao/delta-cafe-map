...
const SEED_LOCATIONS = [
  ...
  { id:'ca-3', name:'Bairro Alto Hotel',
    ...
    verified:true, addedBy:'Delta Oficial', products:['Espresso','Descafeinado'] },
   {
    ...
    hours: 'Seg–Dom 08:00–24:00',
    note: 'O mais antigo café de Braga, 167 anos de portas abertas para a Praça da República.',
    products: ['Expresso', 'Abatanado', 'Delta Q'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 12,
    dddeltaUrl: 'https://dddelta.com/cafe-vianna/'
  },
  {
    id: 'cafe-piolho-porto',
    name: 'O Piolho',
    type: 'cafe',
    lat: 41.1496,
    lng: -8.6109,
    ...
    hours: 'Seg–Sex 08:00–02:00 | Sáb–Dom 10:00–02:00',
    note: 'Mais de um século de história no Porto. Foi aqui servido o primeiro expresso da cidade.',
    products: ['Expresso', 'Cimbalino', 'Delta Q'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 18,
    dddeltaUrl: 'https://dddelta.com/o-piolho/'
  },
  {
    id: 'pastelaria-gomes-vilareal',
    name: 'Pastelaria Gomes',
    type: 'cafe',
    lat: 41.2996,
    lng: -7.7439,
    country: 'Portugal',
    city: 'Vila Real',
    address: 'Vila Real',
    hours: 'Seg–Dom 07:30–20:00',
    note: 'Prestes a cumprir 100 anos, já na terceira geração com a quarta de mãos na massa.',
    products: ['Expresso', 'Abatanado', 'Pastelaria'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 8,
    dddeltaUrl: 'https://dddelta.com/pastaleria-gomes-vila-real/'
  },
  {
    id: 'pastelaria-o-forno',
    name: 'Pastelaria O Forno',
    type: 'cafe',
    lat: 39.7436,
    lng: -8.8071,
    country: 'Portugal',
    ...
    hours: 'Seg–Dom 07:00–20:00',
    note: 'Vasta doçaria regional cozida em fornos elétricos. Tradição e autenticidade.',
    products: ['Expresso', 'Delta Q', 'Pastelaria Regional'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 6,
    dddeltaUrl: 'https://dddelta.com/pastelaria-o-forno/'
  },
  {
    id: 'casa-pao-de-lo-alfeizerao',
    name: 'Casa Pão de Ló de Alfeizerão',
    type: 'cafe',
    lat: 39.6578,
    lng: -8.9812,
    country: 'Portugal',
    city: 'Alfeizerão',
    address: 'Alfeizerão, Caldas da Rainha',
    hours: 'Ter–Dom 09:00–18:00',
    note: 'Desde 1925. O Pão de Ló de Alfeizerão é uma herança e um motivo de peregrinação.',
    products: ['Café', 'Pão de Ló', 'Doçaria Regional'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 14,
    dddeltaUrl: 'https://dddelta.com/casa-pao-de-lo-de-alfeizerao/'
  },
  {
    id: 'nova-sbe-lounge-carcavelos',
    name: 'Lounge Delta — Nova SBE',
    type: 'espresso',
    lat: 38.6837,
    lng: -9.3417,
    country: 'Portugal',
    city: 'Carcavelos',
    address: 'Nova School of Business and Economics, Carcavelos',
    hours: 'Seg–Sex 08:00–20:00',
    note: 'Lounge inaugurado em homenagem ao fundador da Delta Cafés, na Nova SBE.',
    products: ['Expresso', 'Delta Q', 'Abatanado'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 5,
    dddeltaUrl: 'https://dddelta.com/lounge-com-historia/'
  },
  {
    id: 'amalias-flavours-barcelona',
    name: "Amalia's Flavours",
    type: 'cafe',
    lat: 41.3851,
    lng: 2.1734,
    country: 'Espanha',
    ...
    hours: 'Seg–Dom 09:00–20:00',
    note: 'Um pedaço de Portugal no coração de Barcelona. Café e pastelaria portuguesa.',
    products: ['Expresso', 'Delta Q', 'Pastelaria Portuguesa'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 9,
    dddeltaUrl: 'https://dddelta.com/amalias-flavours-barcelona/'
  },
  {
    id: 'casa-dani-madrid',
    name: 'Casa Dani',
    ...
    country: 'Espanha',
    city: 'Madrid',
    address: 'Mercado de la Paz, Madrid',
    hours: 'Seg–Sáb 08:00–17:00',
    note: 'Se a tortilha espanhola fosse religião, a Casa Dani seria o seu templo. Café Delta incluído.',
    products: ['Expresso', 'Delta', 'Tortilha'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 11,
    dddeltaUrl: 'https://dddelta.com/casa-dani-tortilha-cafe/'
  },
  {
    id: 'cafe-du-chateau-paris',
    ...
    hours: 'Seg–Dom 08:00–22:00',
    note: 'Incontornável em Paris. César Martins, o proprietário, garante que não é exagero.',
    products: ['Expresso', 'Delta Q', 'Café Filtrado'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 7,
    dddeltaUrl: 'https://dddelta.com/incontornavel-em-paris-voila/'
  },
  {
    id: 'baron-tavernier-suica',
    name: 'Baron Tavernier — Lago Léman',
    type: 'cafe',
    lat: 46.4312,
    lng: 6.9201,
    country: 'Suíça',
    city: 'Lago Léman',
    address: 'Região do Lago Léman, Suíça',
    hours: 'Seg–Dom 10:00–22:00',
    note: 'Vista deslumbrante para o Lago Léman, numa região classificada como Património UNESCO.',
    products: ['Expresso', 'Delta', 'Café da Manhã'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 10,
    dddeltaUrl: 'https://dddelta.com/baron-tavernier/'
  },
  {
    id: 'cepam-sao-paulo',
    name: 'CEPAM',
    ...
    country: 'Brasil',
    city: 'São Paulo',
    address: 'Zona Leste, São Paulo, Brasil',
    hours: 'Seg–Dom 05:00–22:00',
    note: 'A maior padaria da América Latina, num bairro tradicional da zona leste de São Paulo.',
    products: ['Café', 'Delta', 'Padaria'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 13,
    dddeltaUrl: 'https://dddelta.com/cepam-maior-padaria-da-america-latina/'
  },
  {
    id: 'cafe-nota10-sao-paulo',
    name: 'Café Nota 10',
    type: 'cafe',
    lat: -23.6012,
    lng: -46.6962,
    country: 'Brasil',
    city: 'São Paulo',
    address: 'Avenida de Portugal, Brooklin, São Paulo',
    hours: 'Seg–Dom 06:00–22:00',
    note: 'Na avenida de Portugal no Brooklin, onde se bebe café português em São Paulo.',
    products: ['Expresso', 'Delta Q', 'Pastelaria'],
    verified: true,
    status: 'approved',
    added_by: 'admin',
    upvotes: 8,
    dddeltaUrl: 'https://dddelta.com/cafe-nota-10-sao-paulo/'
  },
];
